...
class Car {
  ...
  drive(distance) {
    ...
    if (gasUsed < this.tank) {
      ...
      this.tank = 0;
      // this next statement is asking how many miles you gonna with whatever is left in your tank.
...
*/
// allow the child to copy the parent , * method
class ProjectManager extends Instructor {
  constructor(pmObject) {
    // apply the parent's property to this child , *property
    super(pmObject);
    this.name = pmObject.name;
